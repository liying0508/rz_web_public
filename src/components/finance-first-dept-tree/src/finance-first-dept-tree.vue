...
<!--  <el-input v-model="showDeptName" :placeholder="placeholder" @focus="deptDialog">
    ...
    <el-input v-model="showDeptName" :placeholder="placeholder" :disabled="disabled" readonly>
      <el-button slot="append" icon="el-icon-search" @click="deptDialog"></el-button>
    </el-input>
  <el-input :value="value" style="display: none" :disabled="disabled"></el-input>
