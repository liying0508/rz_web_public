  ...
  <el-card shadow="never" class="aui-card--fill">
    <div class="mod-financing__fgovernmentbond">
      ...
      <el-table v-loading="dataListLoading"
        ...
        <el-table-column prop="project" label="项目" header-align="center" align="center"></el-table-column>
        ...
        <el-table-column :label="$t('handle')" fixed="right" header-align="center" align="center" width="150">
          <template slot-scope="scope">
            <el-button v-if="$hasPermission('financing:fgovernmentbond:group:audit')" type="text" size="small" @click="addOrUpdateHandle(scope.row.id)">审核</el-button>
          </template>
        </el-table-column>
      </el-table>
      <el-pagination
...
import FgovernmentbondAuditDetails from '@/views/modules/financing/fgovernmentbond-group-audit-details'
