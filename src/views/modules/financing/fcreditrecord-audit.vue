...
<!--          <el-table-column prop="directQuota" label="直接融资" header-align="center" align="center"></el-table-column>-->
        ...
        <el-table-column :label="$t('handle')" fixed="right" header-align="center" align="center" width="150">
          <template slot-scope="scope">
            <el-button v-if="$hasPermission('financing:fcreditrecord:audit')" type="text" size="small" @click="addOrUpdateHandle(scope.row.creditId)">审核</el-button>
          </template>
        </el-table-column>
      </el-table>
      <!-- 弹窗, 新增 / 修改 -->
...
import FcreditrecordAuditDetails from '@/views/modules/financing/fcreditrecord-audit-details'
export default {
