  ...
  <el-card shadow="never" class="aui-card--fill">
    <div class="mod-financing__findirectfinancing">
      <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
        ...
        <el-form-item>
          <ren-select v-model="dataForm.financingType" dict-type="financing_type" placeholder="融资类型"></ren-select>
        </el-form-item> -->
        <el-form-item>
      ...
      height="calc(100vh - 280px)"
        ...
        <el-table-column prop="isChecked" label="审核结果" header-align="center" align="center" min-width="100">
          <template slot-scope="{row}">
        ...
        <el-table-column :label="$t('handle')" fixed="right" header-align="center" align="center" width="150">
          <template slot-scope="scope">
            <el-button v-if="$hasPermission('financing:repaymentinfo:audit')" type="text" size="small" @click="addOrUpdateHandle1(scope.row)">审核</el-button>
          </template>
        </el-table-column>
      </el-table>
      <!-- <el-pagination
...
import AddOrUpdate from './repaymentinfo-audit-detail'
