...
<!--          <template slot-scope="{row}">
        ...
        <el-table-column :label="$t('handle')" fixed="right" header-align="center" align="center" width="150">
          <template slot-scope="scope">
            <el-button v-if="$hasPermission('financing:fdirectfinancing:audit')" type="text" size="small" @click="addOrUpdateHandle(scope.row.id)">审核</el-button>
          </template>
        </el-table-column>
      </el-table>
      <el-pagination
...
import FdirectfinancingAuditDetails from '@/views/modules/financing/fdirectfinancing-audit-details'
export default {
