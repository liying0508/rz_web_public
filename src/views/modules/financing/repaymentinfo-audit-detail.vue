  ...
  <el-dialog :visible.sync="visible"
      ...
      <el-menu :default-active="activeIndex" class="el-menu-demo" mode="horizontal" @select="handleSelect">
        ...
        <el-menu-item index="2" class="form-menu-item">偿还利息</el-menu-item>
              ...
              <el-row>
                <el-form-item label="审核结果：" prop="isChecked"  class="p-left-80">
                  <ren-radio-group v-model="dataForm.isChecked" dict-type="audit_result"></ren-radio-group>
                </el-form-item>
              </el-row>
              <el-row>
                <el-form-item label="审核意见：" prop="checkedDes" class="p-left-80">
                  <el-input type="textarea" placeholder="审核意见" v-model="dataForm.checkedDes" maxlength="200" show-word-limi  class="col-input"></el-input>
                </el-form-item>
              </el-row>
             </el-form>
    ...
    dataFormSubmitHandle: debounce(
      async function () {
        try {
          var params = {
            id: null,
            checked: this.dataForm.isChecked,
            checkedDes: this.dataForm.checkedDes,
            repaymentId: this.dataForm.id
          }
          console.log(params)
          const { data } = await this.$http.post('/financing/repaymentinfo/check', params)
          if (data.code !== 0) {
            return this.$message.error(data.msg)
          }
