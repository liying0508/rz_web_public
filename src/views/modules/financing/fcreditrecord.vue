  ...
  <el-card shadow="never" class="aui-card--fill">
    <div class="mod-financing__fcreditrecord">
      <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
        ...
        <!-- <el-form-item>
          <el-input v-model="dataForm.deptName" placeholder="金融机构" clearable></el-input>
        </el-form-item> -->
        <el-form-item>
...
<!--          <el-table-column prop="directQuota" label="直接融资" header-align="center" align="center"></el-table-column>-->
        ...
        <el-table-column :label="$t('handle')" fixed="right" header-align="center" align="center" width="150">
          <template slot-scope="scope">
            <el-button v-if="$hasPermission('financing:fcreditrecord:update')" type="text" size="small" @click="addOrUpdateHandle(scope.row.creditId)">修改</el-button>
            <el-button v-if="$hasPermission('financing:fcreditrecord:delete')" type="text" size="small" @click="deleteHandle(scope.row.creditId)">{{ $t('delete') }}</el-button>
          </template>
        </el-table-column>
      </el-table>
      <!-- 弹窗, 新增 / 修改 -->
...
import AddOrUpdate from './fcreditrecord-add-or-update'
export default {
  ...
  data () {
    return {
      ...
      mixinViewModuleOptions: {
        ...
        getDataListURL: '/financing/fcreditrecord/list',
