...
<!--            <span class="desc-content"> {{$getDictLabel('varieties',dataForm.varieties)}}</span>-->
            <span class="desc-content"> {{audit.varieties}}</span>
          </el-form-item>
        </el-col>
        <el-col :span="6">
          <el-form-item label="还本方式：" class="p-left-70">
            <span class="desc-content"> {{$getDictLabel('serviceCycle',dataForm.serviceCycle)}}</span>
          </el-form-item>
        </el-col>
        <el-col :span="6">
          <el-form-item label="付息方式：" class="p-left-70">
      ...
      <el-row>
        <el-col :span="6">
          <el-form-item label="固定利率："  class="p-left-70">
            <span class="desc-content">{{dataForm.rate}} %</span>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="主承销商："  class="p-left-70">
            <span class="desc-content">{{dataForm.secComNameText}}</span>
          </el-form-item>
        </el-col>
        <el-col :span="6">
          <el-form-item label="承销费率："  class="p-left-70">
            <span class="desc-content">{{dataForm.underwritingRate}} ‰</span>
          </el-form-item>
        </el-col>
      </el-row>
      <el-row>
      ...
      <el-row>
        ...
        <el-col :span="6">
          <el-form-item label="未发行额度："  class="p-left-80">
        ...
        <el-col :span="6">
          <el-form-item label="是否占用授信："  class="p-left-110">
            <span class="desc-content">{{dataForm.occupancyCreditQuota==0?'否':'是'}} </span>
          </el-form-item>
        </el-col>
      </el-row>
      <el-row>
      ...
      <el-row>
        <el-form-item label="决策依据：" prop="decisionBasis" class="p-left-50">
      ...
      <template  v-for="item in dataForm.investorList">
        <el-row>
          <el-col :span="6" >
            <el-form-item label="债券购买人："  prop="investorName" class="p-left-70">
    ...
    <el-form v-show="activeIndex=='3'" class="custom-form">
      <el-row>
        ...
        <el-col :span="12" >
          <el-form-item label="融资品种：" class="p-left-70">
            <span class="desc-content"> {{audit.varieties}}</span>
          </el-form-item>
        </el-col>
      </el-row>
  ...
  methods: {
    ...
    async getInfo () {
      try {
        ...
        _data.result = _data.isChecked
        _data.opinion = _data.checkedDes
        ...
        const secComNames = this.secComNames.find(item => _data.secComId === item.dictValue)
        this.dataForm.secComNameText = this.$isNotNull(secComNames) ? secComNames.dictValue : ''
    ...
    dataFormSubmitHandle: debounce(function () {
      this.$refs.dataForm.validate(async (valid) => {
        ...
        const { data } = await this.$http.post('/financing/audit/check', {
          checked: result,
          checkedDes: opinion,
          financingId: id
        })
