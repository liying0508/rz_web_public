...
<!--  直融批文审批-->
  <el-card shadow="never" class="aui-card--fill">
    <div class="mod-financing__fdirectfinancing">
      ...
      <el-table v-loading="dataListLoading" :data="dataList" row-key="id" border style="width: 100%;" height="calc(100vh - 280px)">
        ...
        <el-table-column :label="$t('handle')" fixed="right" header-align="center" align="center" width="150">
          <template slot-scope="scope">
            <el-button v-if="$hasPermission('financing:approval:audit')" type="text" size="small" @click="addOrUpdateHandle(scope.row.id)">审核</el-button>
          </template>
        </el-table-column>
      </el-table>
      <!-- 弹窗, 新增 / 修改 -->
...
import ApprovalAuditDetails from '@/views/modules/financing/approval-audit-details'
export default {
