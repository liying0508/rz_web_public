  ...
  <el-card shadow="never" class="aui-card--fill">
    <div class="mod-financing__findirectfinancing">
      ...
      <el-table v-loading="dataListLoading"
        ...
        <el-table-column prop="rate" label="执行利率" header-align="center" align="center">
          <template slot-scope="{row}">
            {{ row.rate?row.rate + '%':0 }}
          </template>
        </el-table-column>
        ...
        <el-table-column prop="result" label="审核结果" header-align="center" align="center" min-width="150">
          <template slot-scope="{row}">
        ...
        <el-table-column :label="$t('handle')" fixed="right" header-align="center" align="center" width="150">
          <template slot-scope="scope">
            <el-button v-if="$hasPermission('financing:findirectfinancing:audit')" type="text" size="small" @click="addOrUpdateHandle(scope.row.id)">审核</el-button>
          </template>
        </el-table-column>
      </el-table>
      <el-pagination
      ...
      <!-- 弹窗, 新增 / 修改 -->
      <findirectfinancing-audit-details v-if="addOrUpdateVisible" ref="addOrUpdate" @refreshDataList="getDataList"></findirectfinancing-audit-details>
    </div>
  </el-card>
</template>
...
import FindirectfinancingAuditDetails from '@/views/modules/financing/findirectfinancing-audit-details'
